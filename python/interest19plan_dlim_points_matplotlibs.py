...
CMBChina_int_6902 = [2.8,3,3.1,3.2,3.4,3.5,3.6,3.65,3.7]
CMBChina_day_6902 = [7,14,21,31,61,91,181,365,9999]
...
CMBC_int_FSA016001A = [3.2,3.4,3.6,3.75,3.9,4,4,4]
CMBC_day_FSA016001A = [6,13,30,60,90,180,365,9999]
...
ICBC_int_BBSXE01 = [2.9,3.05,3.15,3.25,3.35,3.65]
ICBC_day_BBSXE01 = [62,90,181,272,363,393]

ICBC_int_BBSXE02 = [2.95,3.1,3.2,3.3,3.4,3.65]
ICBC_day_BBSXE02 = [62,90,181,272,363,393]
